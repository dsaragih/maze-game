...
public class CharactersTest {
    ...
    public void MerchantTransactionTest(){
        final ArrayList<Item> itemOwned = new ArrayList<>();
        ...
        final Merchant merchant = new Merchant(0,0, itemOwned, null);
        final Player player = new Player(new Point(0,0), null);
        merchant.collideWith(player);
        final boolean[] lst = new boolean[3];
        lst[1] = true;
        lst[2] = true;
    ...
    public void MerchantAwayFromPlayerTest(){
        ...
        merchant.update();
        final boolean[] lst = new boolean[1];
        lst[0]=true;
        merchant.updateNumberKeysPressed(lst);
    ...
    public void EnemyBeingDamagedTest(){
        ...
        final Enemy e = new Enemy(0,0,null);
        assertEquals(1, e.getDamage());
        final Player p = new Player(new Point(0,0), null);
        p.collideWith(e);
    ...
    public void PlayerBeingDamagedTest2(){
        final Player player = new Player(new Point(0,0), null);
        final Mine m = new Mine(new Point(0,0), null, null);
    ...
    public void PlayerBeingHealedTest2(){
        ...
        final HealthFlask flask = new HealthFlask();
        flask.operateOnPlayer(player);
