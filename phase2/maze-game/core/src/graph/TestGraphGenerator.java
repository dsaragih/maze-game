...
public class TestGraphGenerator implements IGraphGenerator{
    ...
    public PlanarGraph generate() {
        ...
        final PlanarNode n7 = new PlanarNode(2,0);
        final PlanarNode n8 = new PlanarNode(5,0);
        final PlanarNode n9 = new PlanarNode(7,1);
        final PlanarNode n10 = new PlanarNode(-1,2);
        final PlanarNode n11 = new PlanarNode(3,2);
        final PlanarNode n12 = new PlanarNode(-1,3);
        final PlanarNode n13 = new PlanarNode(1,3);
        final PlanarNode n14 = new PlanarNode(4,3);
