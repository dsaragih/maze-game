...
public class SandRoomDrawer implements IRoomDrawer {
    ...
    public SandRoomDrawer(final Stage stage, final int screenWidth, final int screenHeight){
        this.stage = stage;

        final Texture texture = new Texture(Gdx.files.internal("chiseled_sandstone.png"));
